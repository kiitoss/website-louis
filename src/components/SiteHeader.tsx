            ...
            <DropdownMenuContent align="end" className="min-w-36">
              <DropdownMenuItem asChild>
                <a href={frUrl} className="flex items-center gap-2.5 cursor-pointer">
                  <img src="/images/flag_fr.webp" alt="Français" className="h-[13px] w-5 object-cover" />
                  <span>Français</span>
              ...
              <DropdownMenuItem asChild>
                <a href={enUrl} className="flex items-center gap-2.5 cursor-pointer">
                  <img src="/images/flag_en.webp" alt="English" className="h-[13px] w-5 object-cover" />
                  <span>English</span>
